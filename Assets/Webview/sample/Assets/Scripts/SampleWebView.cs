...
public class SampleWebView : MonoBehaviour
{
    ...
    public void OpenWebViewerCaller(){
        StartCoroutine(OepnWebViewer());
    }

    public void CloseWebViewerCaller(){
        StopCoroutine(OepnWebViewer());
        Destroy(webViewObject.gameObject);
    }

    IEnumerator OepnWebViewer()
    {
        ...
        //webViewObject.SetMargins(20, 100, 20, Screen.height / 4);
        webViewObject.SetMargins(20, 150, 20, 150);
